...
# $AMD1 -m memory,l3 -d 300 -o ../Naive_Bayes/Server/perfomance.csv -- "../Naive_Bayes/server" 
# echo "Started"
...
# $AMD1 -m memory,l3 -d 300 -o ../Logistic_Regression/Server/perfomance.csv -- "../Logistic_Regression/server" 
# # echo "Started"
# # # # Define the application you want to run
# # # # Loop to run the application 10 times
...
# $AMD1 -m memory,l3 -d 300 -o ../LSVM/Server/perfomance.csv -- "../LSVM/server" 
# # echo "Started"
# # # Define the application you want to run
# # # Loop to run the application 10 times
...
# $AMD1 -m memory,l3 -d 300 -o ../Adaboost/Server/perfomance.csv -- "../Adaboost/server" 
# echo "Started"
# Define the application you want to run
# Loop to run the application 10 times
...
# $AMD1 -m memory,l3 -d 300 -o ../RF/Server/perfomance.csv -- "../RF/server" 
# echo "Started"
# Define the application you want to run
# Loop to run the application 10 times