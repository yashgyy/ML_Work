...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../Naive_Bayes/Client/perfomance.csv -- "../Naive_Bayes/client" &
...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../Logistic_Regression/Client/perfomance.csv -- "../Logistic_Regression/client" &
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../Linear_Regression/Client/perfomance.csv -- "../Linear_Regression/client" &
# # # Define the application you want to run
# # # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../KernelSVM/Client/perfomance.csv -- "../KernelSVM/client" &
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../LSVM/Client/perfomance.csv -- "../LSVM/client" &
# # Define the application you want to run
# # Loop to run the application 10 times
...
$AMD1 -m ipc,fp,l1,l2 -d 300 -o ../KMeans/Client/perfomance.csv -- "../KMeans/client" &
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 300 -o ../Adaboost/Client/perfomance.csv -- "../Adaboost/client" &
# # Define the application you want to run
# # Loop to run the application 10 times
