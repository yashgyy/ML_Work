...
run_profiling() {
    ...
    perf stat --timeout 300000 -e instructions,cpu-cycles -o "$output_path" -x , "$app_path" 
...
declare -A applications=(
    ["Naive_Bayes"]="../Naive_Bayes/server ../Naive_Bayes/IS_IC_ipc_performance_nb.csv"
    ["Logistic_Regression"]="../Logistic_Regression/server ../Logistic_Regression/IS_IC_ipc_performance_lr.csv"
    ["Linear_Regression"]="../Linear_Regression/server ../Linear_Regression/IS_IC_ipc_performance_linear.csv"
    ["KernelSVM"]="../KernelSVM/server ../KernelSVM/IS_IC_ipc_performance_ksvm.csv"
    ["LSVM"]="../LSVM/server ../LSVM/IS_IC_ipc_performance_lsvm.csv"
    ["KMeans"]="../KMeans/server ../KMeans/IS_IC_ipc_performance_kmeans.csv"
    ["Adaboost"]="../Adaboost/server ../Adaboost/IS_IC_ipc_performance_adaboost.csv"
    ["RF"]="../RF/server ../RF/IS_IC_ipc_performance_rf.csv"
)
