...
declare -A applications=(
    ["Naive_Bayes"]="../Naive_Bayes/client ../Naive_Bayes/IC_IS_ipc_performance.csv"
    ["Logistic_Regression"]="../Logistic_Regression/client ../Logistic_Regression/IC_IS_ipc_performance.csv"
    ["Linear_Regression"]="../Linear_Regression/client ../Linear_Regression/IC_IS_ipc_performance.csv"
    ["KernelSVM"]="../KernelSVM/client ../KernelSVM/IC_IS_ipc_performance.csv"
    ["LSVM"]="../LSVM/client ../LSVM/IC_IS_ipc_performance.csv"
    ["KMeans"]="../KMeans/client ../KMeans/IC_IS_ipc_performance.csv"
    ["Adaboost"]="../Adaboost/client ../Adaboost/IC_IS_ipc_performance.csv"
    ["RF"]="../RF/client ../RF/IC_IS_ipc_performance.csv"
)
