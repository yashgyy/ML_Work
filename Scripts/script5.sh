...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../Naive_Bayes/Server/perfomance.csv -- "../Naive_Bayes/server" 
# echo "Started"
...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../Logistic_Regression/Server/perfomance.csv -- "../Logistic_Regression/server" 
# echo "Started"
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../Linear_Regression/Server/perfomance.csv -- "../Linear_Regression/server" 
# echo "Started"
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../KernelSVM/Server/perfomance.csv -- "../KernelSVM/server" 
# echo "Started"
# # Define the application you want to run
# Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../LSVM/Server/perfomance.csv -- "../LSVM/server" 
# echo "Started"
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 120 -o ../KMeans/Server/perfomance.csv -- "../KMeans/server" 
# echo "Started"
# # Define the application you want to run
# # Loop to run the application 10 times
...
# $AMD1 -m ipc,fp,l1,l2 -d 240 -o ../Adaboost/Server/perfomance.csv -- "../Adaboost/server" 
# echo "Started"
# Define the application you want to run
# Loop to run the application 10 times
...
$AMD1 -m ipc,fp,l1,l2 -d 240 -o ../RF/Server/perfomance.csv -- "../RF/server" 
echo "Started"
# Define the application you want to run
# Loop to run the application 10 times