...
declare -A applications=(
    ...
    ["KernelSVM"]="../KernelSVM/client ../KernelSVM/AMDC_IS_bandwidth_performance.csv"
    ["LSVM"]="../LSVM/client ../LSVM/AMDC_IS_bandwidth_performance.csv"
    ["KMeans"]="../KMeans/client ../KMeans/AMDC_IS_bandwidth_performance.csv"
    ["Adaboost"]="../Adaboost/client ../Adaboost/AMDC_IS_bandwidth_performance.csv"
    ["RF"]="../RF/client ../RF/AMDC_IS_bandwidth_performance.csv"
)
