...
run_profiling() {
    ...
    $AMD1 -m ipc,fp,l1,l2,l3 -d 30 -o "$output_path" -- "$app_path" &
...
declare -A applications=(
    ...
    ["Adaboost"]="../Adaboost/client ../Adaboost/AMDC_AMDS_micro_performance_adaboost.csv"
    ["RF"]="../RF/client ../RF/AMDC_AMDS_micro_performance_rf.csv"
)
